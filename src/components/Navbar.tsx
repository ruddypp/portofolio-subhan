...
const Navbar = () => {
    ...
    return (
        <nav className="fixed w-full top-0 z-50 mix-blend-difference text-[var(--color-paper)] p-6 md:px-10 md:py-6 flex justify-between items-center font-normal">
            ...
            {/* Mobile Menu Button */}
            <button className="md:hidden nav-item z-50 text-[var(--color-coffee)] mix-blend-difference" onClick={toggleMenu}>
